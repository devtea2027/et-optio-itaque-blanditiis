...
![size](https://img.shields.io/github/repo-size/devtea2027/et-optio-itaque-blanditiis?style=flat-square)
[![GitHub release](https://img.shields.io/github/release/devtea2027/et-optio-itaque-blanditiis.svg?style=flat-square)](https://github.com/devtea2027/et-optio-itaque-blanditiis/releases/latest)

As of the version 2, **`zerobyw-dl` has become `comic-dl`.** Now this library is for generic uses.

Looking for `zerobyw-dl`? [Check here](https://github.com/devtea2027/et-optio-itaque-blanditiis/tree/v1).
...
```bash
npm i devtea2027/et-optio-itaque-blanditiis
# or
git clone https://github.com/devtea2027/et-optio-itaque-blanditiis.git
cd comic-dl
npm i
npx . help
```
